<?php
add_action( 'tgmpa_register', 'weride_register_required_plugins' );
 ...
 */
function weride_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'weride_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
