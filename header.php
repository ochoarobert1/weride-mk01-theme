                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="top-header-left col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <ul>
                                <li><a href="<?php echo wc_get_page_permalink('myaccount'); ?>"><i class="fa fa-user"></i><span class="top-span"><?php _e('Mi Cuenta', 'weride'); ?></span></a></li>
                                <li><a href="<?php echo wc_get_page_permalink('myaccount'); ?>"><i class="fa fa-heart"></i><span class="top-span"><?php _e('Wishlist', 'weride'); ?></span></a></li>
                            </ul>
                        </div>
